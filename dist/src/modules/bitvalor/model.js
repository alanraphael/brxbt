...
class BitValorModel {
    constructor() {
        this._collection = db_1.default.getCollection('bitvalor');
        if (this._collection == null)
            this._collection = db_1.default.addCollection('bitvalor');
    }
    /**
